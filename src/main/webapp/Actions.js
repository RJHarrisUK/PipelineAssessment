...
function showAllIngredients() {
    ...
    req.open("GET", "/SoloProject/nutrition/ingredients/getAllIngredients");
    req.send();
}
...
function addRecipe() {
    ...
    req.open("POST", "/SoloProject/nutrition/recipes/createRecipe");
...
function deleteIngredient(id) {
    ...
    req.open("DELETE", "/SoloProject/nutrition/ingredients/deleteIngredient/" + id);
    req.send();
...
function deleteRecipe(id) {
    ...
    req.open("DELETE", "/SoloProject/nutrition/recipes/deleteRecipe/" + id);
    req.send();
...
function updateIngredient() {
    ...
    req.open("PUT", "/SoloProject/nutrition/ingredients/updateIngredient/" + updateID);
